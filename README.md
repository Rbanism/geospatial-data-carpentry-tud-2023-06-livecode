...
- Go to the file in which the instructor is now coding:
  - [intro-to-r.R](https://github.com/Rbanism/geospatial-data-carpentry-tud-2023-06-livecode/blob/main/scripts/intro-to-r.R)
  - [vector.R](https://github.com/Rbanism/geospatial-data-carpentry-tud-2023-06-livecode/blob/main/scripts/vector.R)
  - [raster.R](https://github.com/Rbanism/geospatial-data-carpentry-tud-2023-06-livecode/blob/main/scripts/raster.R)
